...
handle_call({join, NewKey, MembershipVector},
    From,
    [InitialNode | Tail]) ->
                ...
                [] ->
                    case InitialNode of
                        ...
                        _ ->
                            ...
                            gen_server:call(InitialNode, {Key, {'join-process-0', From, NewKey, MembershipVector}})
                    end;

                _ ->
                    io:format("test:72\t\t=>   PeerList=~p~n", [PeerList]),
                    [{SelfKey, {_, _, _}} | _] = PeerList,
                    gen_server:call(SelfServer, {SelfKey, {'join-process-0', From, NewKey, MembershipVector}})
            end
    end,
...
% 最もNewKeyに近いピアを探索する
handle_call({SelfKey, {'join-process-0', From, NewKey, MembershipVector}},
    _From,
    [InitialNode | Tail]) ->
                    ...
                    case select_best(Smaller, NewKey) of
                        ...
                        {'__none__', '__none__'} ->
                            ...
                            gen_server:call(SelfServer,
                                {SelfKey, {'join-process-1', From, NewKey, MembershipVector, 0, []}, Next});
                        {'__self__'} ->
                        ...
                        {'__local__', BestKey} ->
                            gen_server:call(SelfServer,
                                {BestKey, {'join-process-0', From, NewKey, MembershipVector}});
                        {Server, BestKey} ->
...
handle_call({SelfKey, {'join-process-1', From, NewKey, MembershipVector, Level, Neighbor}, Next},
    _From,
    State) ->
    ...
    F = fun() ->
            ...
            case Level of
                0 ->
                    ?NOW('join-process-1: 0'),
                    if
                        NewKey < SelfKey ->
                            gen_server:call(SelfServer,
                                {SelfKey, {'join-process-1', From, NewKey, MembershipVector, Level + 1, [{SelfKey, SelfServer}]}, Next});
                        SelfKey < NewKey ->
                            gen_server:call(SelfServer,
                                {SelfKey, {'join-process-1', From, NewKey, MembershipVector, Level + 1, [{SelfKey, SelfServer}]}, Next})
                    end;
                    ...
                    case NextNode of
                        ...
                        _ ->
                            gen_server:call(NextNode,
                                {NextKey, {'join-process-2', From, NewKey, MembershipVector, 0, Neighbor, []}})
                    end;
                ...
                _ ->
                    ...
                    io:format("    Level=~p, SelfBit=~p, Bit=~p, NewKey=~p, SelfKey=~p~n", [Level, SelfBit, Bit, NewKey, SelfKey]),
                    ...
                    if
                        NewKey < SelfKey ->
                            case Bit of
                                SelfBit ->
                                    gen_server:call(SelfServer,
                                        {SelfKey, {'join-process-1', From, NewKey, MembershipVector, Level + 1, [{SelfKey, SelfServer} | Neighbor]}, Next});
                                _ ->
                                            ...
                                            case Next of
                                                {'__none__', '__none__'} ->
                                                    gen_server:reply(From,
                                                        {lists:duplicate(?LEVEL_MAX, {'__none__', '__none__'}), [Remnant | Neighbor]});
                                                {NextNode, NextKey} ->
                                                    io:format("    NextNode=~p, NextKey=~p~n", [NextNode, NextKey]),
                                                    gen_server:call(NextNode,
                                                        {NextKey, {'join-process-2', From, NewKey, MembershipVector, 0, [Remnant | Neighbor], []}})
                                            end;
                                        _ ->
                                            gen_server:call(BiggerNode,
                                                {BiggerKey, {'join-process-1', From, NewKey, MembershipVector, Level, Neighbor}, Next})
                                    end
                            end;
                                    ...
                                    case SmallerNode of
                                        '__none__' ->
                                            case Next of
                                                {'__none__', '__none__'} ->
                                                    gen_server:reply(From,
                                                        {[Remnant | Neighbor], lists:duplicate(?LEVEL_MAX, {'__none__', '__none__'})});
                                                {NextNode, NextKey} ->
                                                    gen_server:call(NextNode,
                                                        {NextKey, {'join-process-2', From, NewKey, MembershipVector, 0, [Remnant | Neighbor], []}})
                                            end;
                                        _ ->
                                            gen_server:call(SmallerNode,
                                                {SmallerKey, {'join-process-1', From, NewKey, MembershipVector, Level, Neighbor}, Next})
                                    end
                            end
                    end
            end
...
handle_call({SelfKey, {'join-process-2', From, NewKey, MembershipVector, Level, AnotherNeighbor, Neighbor}},
    _From,
    State) ->
            ...
            case Level of
                ...
                0 ->
                    ...
                    if
                        NewKey < SelfKey ->
                            gen_server:call(SelfServer,
                                {SelfKey, {'join-process-2', From, NewKey, MembershipVector, Level + 1, AnotherNeighbor, [{SelfKey, SelfServer}] }});
                        SelfKey < NewKey ->
                            gen_server:call(SelfServer,
                                {SelfKey, {'join-process-2', From, NewKey, MembershipVector, Level + 1, AnotherNeighbor, [{SelfKey, SelfServer}] }})
                    end;
                    ...
                    if
                        NewKey < SelfKey ->
                            case Bit of
                                SelfBit ->
                                    gen_server:call(SelfServer,
                                        {SelfKey, {'join-process-2', From, NewKey, MembershipVector, Level + 1, AnotherNeighbor, [{SelfKey, SelfServer} | Neighbor]}});
                                _ ->
                                    {BiggerNode, BiggerKey} = lists:nth(Level, Bigger),
                                    case BiggerNode of
                                        '__none__' ->
                                            Remnant = lists:duplicate(?LEVEL_MAX - Level, {'__none__', '__none__'}),
                                            gen_server:reply(From, {[Remnant | Neighbor], AnotherNeighbor});
                                        _ ->
                                            gen_server:call(BiggerNode,
                                                {BiggerKey, {'join-process-2', From, NewKey, MembershipVector, Level, AnotherNeighbor, Neighbor}})
                                    end
                            end;
                            ...
                            case Bit of
                                ...
                                _ ->
                                    ...
                                    case SmallerNode of
                                        '__none__' ->
                                            Remnant = lists:duplicate(?LEVEL_MAX - Level, {'__none__', '__none__'}),
                                            gen_server:reply(From, {AnotherNeighbor, [Remnant | Neighbor]});
                                        _ ->
                                            gen_server:call(SmallerNode,
                                                {SmallerKey, {'join-process-2', From, NewKey, MembershipVector, Level, AnotherNeighbor, Neighbor}})
                                    end
                            end
                    end
            end
...
join(Key) ->
    ...
    {Smaller, Bigger} = gen_server:call(Server, {join, Key, MembershipVector}, infinity),
